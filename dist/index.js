"use strict";var n=function(r,u){return function(){try{return u||r((u={exports:{}}).exports,u),u.exports}catch(t){throw (u=0, t)}};};var p=n(function(s0,f){
...
var h=require('@stdlib/math-base-assert-is-nan/dist'),d=require('@stdlib/math-base-special-exp/dist'),j=require('@stdlib/number-float64-base-set-low-word/dist'),k=require('@stdlib/constants-float64-pinf/dist'),D=require('@stdlib/constants-float64-ninf/dist'),G=p(),H=y(),J=A(),K=P(),O=Q(),U=S(),V=I(),Z=F(),v=1e-300,_=13877787807814457e-33,g=.8450629115104675,$=.12837916709551256,x=1,r0=-.0023621185607526594,e0=1,t0=-.009864944034847148,u0=1,i0=-.0098649429247001,a0=1;function n0(r){var u,t,a,i,e,o,s,l;if(h(r))return NaN;if(r===k)return 0;if(r===D)return 2;if(r===0)return 1;if(r<0?(u=!0,t=-r):(u=!1,t=r),t<.84375)return t<_?1-r:(a=r*r,i=$+a*G(a),e=x+a*H(a),o=i/e,r<.25?1-(r+r*o):(i=r*o,i+=r-.5,.5-i));if(t<1.25)return e=t-1,s=r0+e*J(e),l=e0+e*K(e),u?1+g+s/l:1-g-s/l;if(t<28){if(e=1/(t*t),t<2.857142857142857)i=t0+e*O(e),e=u0+e*U(e);else{if(r<-6)return 2-v;i=i0+e*V(e),e=a0+e*Z(e)}return a=j(t,0),i=d(-(a*a)-.5625)*d((a-t)*(a+t)+i/e),u?2-i/t:i/t}return u?2-v:v*v}m.exports=n0
